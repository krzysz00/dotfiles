...
typeset -U PATH path
path=(~/progs/bin ~/.local/bin ~/amd-scripts/bin $THEROCK_ROOT/bin $RBENV_ROOT/bin $PYENV_ROOT/bin ~/therock-build/install/bin ~/.cargo/bin ~/.krew/bin $path ~/progs/android/android/tools ~/progs/android/android/platform-tools)
